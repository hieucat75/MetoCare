...
export default function ForgotPasswordPage() {
  ...
  if (submitted) {
    return (
      <div className="text-center py-4">
        ...
        <h2 className="text-[24px] font-bold text-text mb-2">Tính năng sắp ra mắt</h2>
        ...
        <Link
          href="/login"
          className="text-[17px] text-mint-700 font-semibold hover:underline underline-offset-2"
        >
          ← Quay lại đăng nhập
        </Link>
      </div>
  ...
  return (
    <div>
      <h1 className="text-[24px] font-bold text-text mb-1">Quên mật khẩu</h1>
