  ...
  return (
    <div className="p-4 lg:p-6 space-y-6 max-w-2xl mx-auto pb-10">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div>
              ...
              {!editingEmail ? (
                ...
                <div className="space-y-2">
                  <Input
                    ...
                    fullWidth
                  />
                  {emailError && <p className="text-caption text-danger">{emailError}</p>}
              ...
              {emailSuccess && <p className="text-caption text-success mt-1">Đã cập nhật email.</p>}
            </div>
            ...
            <div>
              ...
              {pwSuccess && <p className="text-caption text-success mt-1">Đã đổi mật khẩu thành công.</p>}
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card variant="glass" padding="md">
        ...
        <CardContent>
          <p className="text-body-sm text-text-muted">MetoCare v1.0.2 (MVP)</p>
        </CardContent>
      </Card>
