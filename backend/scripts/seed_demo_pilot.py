...
PILOT_PATIENTS = [
    ...
    (
        ...
        165.0, 76.0, 94.0,
        "high",
        "Bệnh tim mạch vành (nhồi máu cơ tim 2021), Đái tháo đường type 2, "
        "Tăng huyết áp độ 2",
        "Không có",
...
METRIC_SPECS: dict[str, list[tuple]] = {
    "+84901234501": [
        ("blood_pressure_systolic", "mmHg",
         lambda i: round(158.0 - i * 0.3 + (i % 3) * 1.5, 1), 90.0, 130.0),
        ("blood_pressure_diastolic", "mmHg",
         lambda i: round(96.0 - i * 0.15 + (i % 4) * 0.8, 1), 60.0, 85.0),
        ("fasting_glucose", "mg/dL",
         lambda i: round(182.0 - i * 0.8 + (i % 5) * 3.0, 1), 70.0, 99.0),
        ("weight_kg", "kg",
         lambda i: round(88.0 - i * 0.04, 1), None, None),
        ("heart_rate", "bpm",
         lambda i: round(82.0 + (i % 7) * 1.0, 0), 60.0, 100.0),
        ("hba1c", "%",
         lambda i: round(8.2 - i * 0.02, 1), 0.0, 5.7),
    ],
    "+84901234502": [
        ("total_cholesterol", "mg/dL",
         lambda i: round(238.0 - i * 0.5, 1), 0.0, 200.0),
        ("ldl_cholesterol", "mg/dL",
         lambda i: round(162.0 - i * 0.4, 1), 0.0, 100.0),
        ("hdl_cholesterol", "mg/dL",
         lambda i: round(42.0 + i * 0.1, 1), 50.0, 999.0),
        ("triglycerides", "mg/dL",
         lambda i: round(218.0 - i * 0.6, 1), 0.0, 150.0),
        ("fasting_glucose", "mg/dL",
         lambda i: round(105.0 + (i % 6) * 1.0, 1), 70.0, 99.0),
        ("weight_kg", "kg",
         lambda i: round(78.0 - i * 0.03, 1), None, None),
        ("blood_pressure_systolic", "mmHg",
         lambda i: round(136.0 + (i % 4) * 1.5, 1), 90.0, 130.0),
        ("blood_pressure_diastolic", "mmHg",
         lambda i: round(88.0 + (i % 3) * 1.0, 1), 60.0, 85.0),
    ],
    "+84901234504": [
        ("fasting_glucose", "mg/dL",
         lambda i: round(148.0 - i * 1.2 + (i % 4) * 4.0, 1), 70.0, 99.0),
        ("hba1c", "%",
         lambda i: round(9.1 - i * 0.04, 1), 0.0, 5.7),
        ("creatinine", "mg/dL",
         lambda i: round(1.42 + (i % 5) * 0.02, 2), 0.5, 1.1),
        ("egfr", "mL/min/1.73m²",
         lambda i: round(64.0 - i * 0.1, 1), 60.0, 999.0),
        ("blood_pressure_systolic", "mmHg",
         lambda i: round(144.0 - i * 0.2, 1), 90.0, 130.0),
        ("blood_pressure_diastolic", "mmHg",
         lambda i: round(88.0 - i * 0.1, 1), 60.0, 85.0),
        ("weight_kg", "kg",
         lambda i: round(65.0 + (i % 3) * 0.1, 1), None, None),
    ],
    "+84901234507": [
        ("blood_pressure_systolic", "mmHg",
         lambda i: round(152.0 - i * 0.4 + (i % 5) * 1.0, 1), 90.0, 130.0),
        ("blood_pressure_diastolic", "mmHg",
         lambda i: round(94.0 - i * 0.2, 1), 60.0, 85.0),
        ("fasting_glucose", "mg/dL",
         lambda i: round(168.0 - i * 0.9 + (i % 3) * 2.0, 1), 70.0, 99.0),
        ("hba1c", "%",
         lambda i: round(8.8 - i * 0.03, 1), 0.0, 5.7),
        ("ldl_cholesterol", "mg/dL",
         lambda i: round(88.0 - i * 0.2, 1), 0.0, 70.0),
        ("total_cholesterol", "mg/dL",
         lambda i: round(178.0 - i * 0.3, 1), 0.0, 200.0),
        ("heart_rate", "bpm",
         lambda i: round(74.0 + (i % 6) * 1.0, 0), 60.0, 100.0),
        ("weight_kg", "kg",
         lambda i: round(76.0 - i * 0.02, 1), None, None),
    ],
    "+84901234503": [
        ("fasting_glucose", "mg/dL",
         lambda i: round(106.0 + (i % 8) * 1.5 - i * 0.1, 1), 70.0, 99.0),
        ("weight_kg", "kg",
         lambda i: round(82.0 - i * 0.05, 1), None, None),
        ("blood_pressure_systolic", "mmHg",
         lambda i: round(132.0 + (i % 4) * 1.0 - i * 0.05, 1), 90.0, 130.0),
        ("blood_pressure_diastolic", "mmHg",
         lambda i: round(84.0 + (i % 3) * 0.5, 1), 60.0, 85.0),
        ("hba1c", "%",
         lambda i: 6.1, 0.0, 5.7),
        ("heart_rate", "bpm",
         lambda i: round(78.0 + (i % 5) * 1.0, 0), 60.0, 100.0),
    ],
    "+84901234506": [
        ("fasting_glucose", "mg/dL",
         lambda i: round(103.0 + (i % 6) * 1.0, 1), 70.0, 99.0),
        ("tsh", "mIU/L",
         lambda i: round(6.8 - i * 0.05, 2), 0.4, 4.0),
        ("weight_kg", "kg",
         lambda i: round(70.0 - i * 0.04, 1), None, None),
        ("blood_pressure_systolic", "mmHg",
         lambda i: round(128.0 + (i % 4) * 1.0, 1), 90.0, 130.0),
        ("blood_pressure_diastolic", "mmHg",
         lambda i: round(82.0 + (i % 3) * 0.5, 1), 60.0, 85.0),
    ],
    "+84901234509": [
        ("blood_pressure_systolic", "mmHg",
         lambda i: round(134.0 - i * 0.1, 1), 90.0, 130.0),
        ("blood_pressure_diastolic", "mmHg",
         lambda i: round(86.0 - i * 0.05, 1), 60.0, 85.0),
        ("fasting_glucose", "mg/dL",
         lambda i: round(99.0 + (i % 7) * 1.0, 1), 70.0, 99.0),
        ("weight_kg", "kg",
         lambda i: round(78.0 - i * 0.06, 1), None, None),
        ("heart_rate", "bpm",
         lambda i: round(86.0 - i * 0.3, 0), 60.0, 100.0),
    ],
    "+84901234510": [
        ("total_cholesterol", "mg/dL",
         lambda i: round(214.0 - i * 0.3, 1), 0.0, 200.0),
        ("ldl_cholesterol", "mg/dL",
         lambda i: round(138.0 - i * 0.25, 1), 0.0, 100.0),
        ("hdl_cholesterol", "mg/dL",
         lambda i: round(52.0 + i * 0.05, 1), 50.0, 999.0),
        ("fasting_glucose", "mg/dL",
         lambda i: round(97.0 + (i % 5) * 1.0, 1), 70.0, 99.0),
        ("weight_kg", "kg",
         lambda i: round(68.0 + (i % 4) * 0.1, 1), None, None),
    ],
    "+84901234505": [
        ("fasting_glucose", "mg/dL",
         lambda i: round(88.0 + (i % 5) * 1.0, 1), 70.0, 99.0),
        ("blood_pressure_systolic", "mmHg",
         lambda i: round(112.0 + (i % 4) * 1.0, 1), 90.0, 130.0),
        ("blood_pressure_diastolic", "mmHg",
         lambda i: round(72.0 + (i % 3) * 0.5, 1), 60.0, 85.0),
        ("heart_rate", "bpm",
         lambda i: round(58.0 + (i % 6) * 1.0, 0), 60.0, 100.0),
        ("weight_kg", "kg",
         lambda i: round(68.0 + (i % 3) * 0.2, 1), None, None),
        ("total_cholesterol", "mg/dL",
         lambda i: round(168.0 + (i % 4) * 1.0, 1), 0.0, 200.0),
    ],
    "+84901234508": [
        ("fasting_glucose", "mg/dL",
         lambda i: round(84.0 + (i % 5) * 0.8, 1), 70.0, 99.0),
        ("blood_pressure_systolic", "mmHg",
         lambda i: round(110.0 + (i % 4) * 0.8, 1), 90.0, 130.0),
        ("blood_pressure_diastolic", "mmHg",
         lambda i: round(70.0 + (i % 3) * 0.5, 1), 60.0, 85.0),
        ("heart_rate", "bpm",
         lambda i: round(68.0 + (i % 5) * 1.0, 0), 60.0, 100.0),
        ("weight_kg", "kg",
         lambda i: 65.0, None, None),
    ],
}
...
MED_SPECS: dict[str, list[tuple]] = {
    ...
    "+84901234502": [
        ("Atorvastatin", "20mg",
         "1 lần/ngày (tối)",
         "Theo dõi men gan sau 3 tháng"),
        ("Fenofibrate", "160mg",
         "1 lần/ngày (trong bữa ăn)",
         "Điều trị tăng triglycerid"),
        ("Omega-3", "1000mg",
         "2 lần/ngày (sau ăn)",
         "Hỗ trợ hạ triglycerid, uống cùng bữa ăn"),
    ],
    "+84901234503": [
        ("Metformin", "500mg",
    ...
    "+84901234504": [
        ("Insulin glargine (Lantus)", "10 đơn vị",
         "1 lần/ngày (21h00)",
         "Tiêm dưới da vùng bụng, xoay vị trí tiêm"),
        ("Metformin", "850mg",
         "2 lần/ngày (sáng và tối, sau ăn)",
         "Giảm liều nếu eGFR <45"),
        ("Lisinopril", "10mg",
         "1 lần/ngày (sáng)",
         "Bảo vệ thận, theo dõi creatinine mỗi 3 tháng"),
        ("Furosemide", "20mg",
         "1 lần/ngày (sáng)",
         "Uống buổi sáng để tránh tiểu đêm"),
    ...
    "+84901234506": [
        ...
        ("Calcium + Vitamin D3", "500mg + 400 IU",
    ...
    "+84901234507": [
        ...
        ("Bisoprolol", "2.5mg",
         "1 lần/ngày (sáng)",
         "Không ngừng đột ngột, theo dõi nhịp tim"),
    ],
    "+84901234508": [
        ("Sắt (II) fumarat", "60mg",
         "1 lần/ngày (sáng, lúc đói)",
    ...
    "+84901234510": [
        ("Atorvastatin", "10mg",
         "1 lần/ngày (tối)",
         "Bắt đầu liều thấp, đánh giá lại sau 6 tuần"),
        ("Calcium carbonate + Vitamin D3", "600mg + 400 IU",
         "2 lần/ngày (sau ăn sáng và tối)",
         "Dự phòng loãng xương giai đoạn tiền mãn kinh"),
        ("Omega-3", "1000mg",
         "1 lần/ngày (sau ăn)",
         "Hỗ trợ tim mạch và hạ triglycerid nhẹ"),
        ("Vitamin E", "400 IU",
         "1 lần/ngày (sau ăn)",
...
def _seed_adherence(
    db, patient_id: str, meds: list[Medication], now: dt.datetime
) -> int:
    if not meds:
        return 0
    db.flush()
...
def seed(db) -> dict:
    ...
    for row in PILOT_PATIENTS:
        (
            phone, password, full_name, dob, gender,
            height_cm, weight_kg, waist_cm, risk_segment,
